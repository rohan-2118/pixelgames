...
type StrategyAdapter<TRelay, TConfig extends BaseRoomConfig = JoinRoomConfig> = {
  ...
  announce: (relay: TRelay, rootTopic: string, selfTopic: string, extraPayload?: Record<string, unknown>, context?: StrategyContext<TConfig>) => MaybePromise<AnnounceResult | void>;
...
type TopicStrategyAdapter<TRelay, TConfig extends BaseRoomConfig = JoinRoomConfig> = {
  ...
  publishTopic: (relay: TRelay, topic: string, msg: StrategyMessage, context: TopicPublishContext) => MaybePromise<AnnounceResult | void>;
...
//#endregion
export { ActionProgressContext, ActionProgressHandler, AddMediaOptions, AnnounceResult, BaseRelayConfig, BaseRoomConfig, CandidateSignal, DataPayload, HandshakePayload, HandshakeReceiver, HandshakeSender, JoinError, JoinErrorHandler, JoinRoom, JoinRoomCallbacks, JoinRoomConfig, JsonPrimitive, JsonValue, MaybePromise, MediaIdentityCache, MessageAction, MessageActionConfig, MessageContext, OfferRecord, PeerHandle, PeerHandlers, PeerHandshake, PeerResult, PeerTarget, ProgressHandler, RelayConfig, RemoteTrackRef, RemoveMediaOptions, RequestAction, RequestActionConfig, RequestContext, RequestManyOptions, RequestOptions, Room, SendOptions, SessionSignal, SharedMediaPeer, Signal, SignalPeer, SocketClient, StrategyAdapter, StrategyContext, StrategyMessage, StrategyOnMessage, TargetPeers, TopicPublishContext, TopicStrategyAdapter, TopicSubscriptionContext, TurnServerConfig };
